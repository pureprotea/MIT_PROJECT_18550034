<?php
  ...
  $page_title = 'Reserved Book Report';
  ?>
...
<?php
  ...
  echo '<th>ACCESSION_NUM</th>';
  echo '<th>SHELF_INFO</th>';
  echo '<th>RESERVED_DATE</th>';
  echo '<th>ISBN</th>';
  ...
  while ($row = mysqli_fetch_array($result1)) {
    ...
    echo '<td valign="top" width="100">' . $row['RESERVATION_ID'] . '</td>';
    echo '<td valign="top" width="100">' . $row['MEMBERSHIP_ID'].'</td>';
    echo '<td valign="top" width="170">' . $row['FIRST_NAME'] . '</td>';
    echo '<td valign="top" width="100">' . $row['TICKET_ID']. '</td>';
    echo '<td valign="top" width="100">' . $row['ACCESSION_NUM'] . '</td>';
    echo '<td valign="top" width="100">' . $row['SHELF_INFO']. '</td>';
    echo '<td valign="top" width="100">' . $row['RESERVED_DATE'] . '</td>';
    echo '<td valign="top" width="150">' . $row['ISBN'] . '</td>';
	echo '<td valign="top" width="500">' . $row['BOOK_TITLE'] . '</td>';
    echo '</tr>';
  } 
  echo '</table>';
