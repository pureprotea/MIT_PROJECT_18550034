...
$l_chg_user_id = $row['L_CHG_USER_ID'];
	...
	//if invalid bd_id no keyed in through url redirects to host_campaign.php
	else{
...
if ($result) {
    ...
    echo 'window.location.href = "http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/host_campaign.php";'; 
    echo '</script>';
...
?>
  ...
  <div class="left" style="width:60%">
	 <h2>Campaign Details</h2>
	  ...
	  <div class="button">
		<input type="submit" class="submit" value="Host Campaign" name="submit" />
	  </div>
...
<div class="right" style="width:40%">
	...
	<div>
		<a href='bd_status_update.php' style="display: inline-block; margin-top: 130px;float:right;width:46.5px;padding-left:30px;padding-right:30px;">
