...
<div class="right">
	  ...
	  <div class="field">
		...
		<input type="submit" class="sumbit" value="Update User" name="submit" />
		 ...
		 <a href='edit_user.php'><img id='button_right' src='/blood_management/admin/images/back.png' alt='BACK'/></a>
	 
		 <a href='edit_user_det.php?user_id=<?php echo $user_id;?>'><img id='button_right' src='/blood_management/admin/images/refresh.png' alt='REFRESH'/></a>
