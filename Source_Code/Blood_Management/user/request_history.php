...
$userid=strtoupper($_SESSION['user_id']);
  ...
  $query = "select * from $table where requester_id='$userid' ORDER BY request_id ";
  ...
  while ($row = mysqli_fetch_array($result1)) {
    ...
    echo '<td valign="top" width="50">' . $row['request_id'] . '</td>';
    ...
    echo '<td valign="top" width="100">' . $row['status'] . '</td>';
