...
<div class="leftonly" style="padding-top:6%; width:75%">
	...
	<?php 
	if($user_status!='EL'){ ?>
		<form name="activateform" action="donor_registration.php" method="POST" onsubmit="return confirm('Do you want to Register as Donor?');">
	<?php } 
	else { ?>
	...
	<?php } ?>
      ...
      <div class="left">
		...
		if($user_status!='EL'){ ?>
			...
			<input type="submit" class="submit" value="Register as Donor" name="submit" />
